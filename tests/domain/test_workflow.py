...
#     WebSummaryWorkflow,
# )
# from llm_chatbot_for_messengers.domain.specification import WorkflowNodeConfig
...
#             template_name='test',
#             llm_config=LLM(model='gpt-4o-mini-2024-07-18', max_tokens=200),
#         )
#     }
...
#             node_name='summary_node',
#             template_name='test',
#             llm_config=LLM(model='gpt-4o-mini-2024-07-18', temperature=0.4, max_tokens=100),
#         ),
#         'answer_node': WorkflowNodeConfig(
#             node_name='answer_node',
#             template_name='kakao_v3',
#             llm_config=LLM(model='gpt-4o-2024-11-20', temperature=0.52, max_tokens=100),
#         ),
#     }
