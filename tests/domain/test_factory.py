...
from llm_chatbot_for_messengers.domain.chatbot import Chatbot, ChatbotState
from llm_chatbot_for_messengers.domain.factory import ChatbotFactory
from llm_chatbot_for_messengers.domain.specification import ChatbotSpecification, MemorySpecification, PromptSpecification, WorkflowNodeSpecification, WorkflowSpecification
    ...
    chatbot_spec = ChatbotSpecification(
        workflow_spec=WorkflowSpecification(
            start_node_spec=WorkflowNodeSpecification[ChatbotState, ChatbotState](
                ...
                children_spec=[WorkflowNodeSpecification[ChatbotState, ChatbotState](
                    initial_schema=ChatbotState,
                    final_schemas=(ChatbotState,),
                    name="end",
                    func=lambda x, y, z: (x, y, z),
        ...
        prompt_specs=[PromptSpecification(
            node="start",
            name="test",
        )],
        timeout=5,
